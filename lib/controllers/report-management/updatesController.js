...
const createUpdate = async (req, res) => {
  try {
    ...
    const addNewUpdate = await newUpdate.save();

    //save the new update's ID to Report DB
    await Report.findByIdAndUpdate(req.body.reportId, {
      $push: { updates: addNewUpdate._id },
    });
...
export { createUpdate, findUpdate, getUpdate, removeUpdate, editUpdate };
